...
<head>
    ...
    <title>{{ config('app.name', 'Biashara Board') }}</title>
...
<body>
    <div id="app">
       ...
       <!--   {{ config('app.name', 'Biashara Board') }} -->
                        ...
                        @else
                            ...
                            <li class="hidden-xs">
                                <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="glyphicon glyphicon-off"></i></a>
                            </li>
